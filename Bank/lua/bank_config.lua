BANK_CONFIG = {} 
BANK_CONFIG.MinGovernment = 4 -- Minimum number of teams considered cops by the Bank needed to start a robbery. (0 to disable)
BANK_CONFIG.MinBankers = 1 -- Minimum number of teams considered bankers by the Bank needed to start a robbery. (0 to disable)
BANK_CONFIG.MinPlayers = 2 -- Minimum of players needed to start a robbery. (0 to disable)
...
BANK_CONFIG.MaxDistance = 900 -- The maximum distance that you can go from the vault during a robbery.
...
BANK_CONFIG.InterestTime = 150 -- The delay between increasing the vault's reward.
BANK_CONFIG.SaviorReward = 10000 -- The reward for killing the robber.
BANK_CONFIG.Government = { -- The teams considered cops by the bank.
    ['Police Officer'] = true, -- uses the name displayed in the F4 menu. (Uses the name displayed in the F4 menu)
    ['Police Chief'] = true,
    ['SWAT'] = true,
    ['Heavy SWAT (V.I.P)'] = true,
}
...
BANK_CONFIG.Robbers = { -- The teams that can rob the vault. (Uses the name displayed in the F4 menu)
    ['Thief'] = true, 
    ['Militia'] = true,
    ['Heavy Militia (V.I.P)'] = true,
    ['Resistance Leader'] = true,
    ['Dr. X'] = true,
}